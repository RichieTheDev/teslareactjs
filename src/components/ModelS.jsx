...
import ModelSj from '../assets/ModelSj.jpg'


const ModelS = () => {
  return (
    <div className='bg-cover snap-mandatory snap-y h-screen bg-no-repeat bg-center ' style={{backgroundImage: `url(${ModelSj})`}}>
      <div className='max-w-[1240px] justify-between flex snap-start  mx-auto items-center '>
        ...
        <div className='flex flex-col mt-12 justify-center items-center'>
          <div>
            <h1 className='text-5xl font-bold text-center mb-2'>Model S</h1>
