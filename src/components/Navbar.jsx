...
import Model3p from '../assets/Model3p.jpg'
...
const Navbar = () => {
  ...
  return (
    <div className='bg-cover snap-mandatory snap-y h-screen bg-no-repeat bg-center ' style={{backgroundImage: `url(${Model3p})`}}>
      <div className='max-w-[1240px] justify-between flex snap-start mx-auto items-center '>
        ...
        <div >
          <ul className='md:flex items-center hidden mt-4 font-medium space-x-6 mx-auto'>
        ...
        <div >
          <ul className='md:flex hidden items-center mt-4 font-medium space-x-6 mx-auto'>
            <li>Shop</li>
            <li>Acccount</li>
            <li>Menu</li>
          </ul>
