...
import ModelYj from '../assets/ModelYj.jpg'


const ModelY = () => {
  return (
    <div className='bg-cover  snap-mandatory snap-y h-screen bg-no-repeat bg-center ' style={{backgroundImage: `url(${ModelYj})`}}>
