...
import SolarRoofj from '../assets/SolarRoofj.webp'


const Solarroof = () => {
  return (
    <div className='bg-cover snap-mandatory snap-y h-screen bg-no-repeat bg-center ' style={{backgroundImage: `url(${SolarRoofj})`}}>
      <div className='max-w-[1240px] justify-between flex snap-start  mx-auto items-center '>
        ...
        <div >
          <ul className='flex items-center mt-4 font-medium space-x-6 mx-auto'>
            <li>Shop</li>
            <li>Acccount</li>
            <li>Menu</li>
          </ul>
